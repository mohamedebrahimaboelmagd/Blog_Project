        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    ...
                    <div>
                        @if (session('statusFooter'))
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                <strong>Success</strong> {{ session('statusFooter') }}
                        ...
                        <form action="{{ route('subscriber.store.footer') }}" method="POST" class="form-inline">
                            @csrf
                            <div class="d-flex flex-row">

                                <input class="form-control"
                                    name="emailfooter" placeholder="Enter Email" onfocus="this.placeholder = ''"
                                    onblur="this.placeholder = 'Enter Email '" required="" type="text">
                            ...
                            <x-input-error :messages="$errors->get('emailfooter')" class="mt-2" />
                        </form>
                    </div>
                </div>
            </div>
