    ...
    <div class="main_menu">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container box_1620">
                ...
                <a class="navbar-brand logo_h" href="{{ route('theme.index') }}"><img src="{{ asset('assets/img/logo.png') }}"
                        alt=""></a>
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    ...
                    <!-- Add new blog -->
                    @auth
                        <a href="{{ route('blogs.create') }}" class="btn btn-sm btn-primary mr-2">New Blog</a>
                    @endauth
                    <!-- End - Add new blog -->
                    ...
                    <ul class="nav navbar-nav navbar-right navbar-social">
                        ...
                        @if (!Auth::check())
                            <div class="d-flex justify-between align-items-center">
                                <a href="{{ route('register') }}" class="btn btn-sm btn-warning mr-1">Register</a>
